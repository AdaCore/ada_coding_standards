...
Many of these rules can also be considered "good" programming practices. As such, many of them can be directly correlated to the ISO/IEC Guidance to Avoiding Vulnerabilities in Programming Languages [TR24772]_. When a rule addresses one of these vulnerabilities, it is listed in the appropriate subsection.
